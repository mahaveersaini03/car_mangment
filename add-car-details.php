...
<div class="app-wrapper">
  ...
  <circle cx="8" cy="4.5" r="1"/>
									    ...
									    <input type="number" min="10000" max="19999"  class="form-control" id="setting-input-1" value="Type VIN." name="VIN" required>
									</div>
									<div class="mb-3 col-sm-6 col-md-4">
									    <label for="setting-input-2" class="form-label">Car Model Year</label>
									    <input type="number" min="1900" name="YEAR" max="2099" step="1" class="form-control" id="setting-input-2" value="Car Model Year" required>
									</div>
                                    <div class="mb-3 col-sm-6 col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3  col-sm-6 col-md-4">
									    ...
									    <input type="text" name="Transmission" class="form-control" id="setting-input-3" value="hello@companywebsite.com">
									</div>
                                    </div>
                                    <div class="row">
                                    <div class="mb-3 col-sm-6 col-md-4">
									...
									<button type="submit" class="btn app-btn-primary" value="submit" >Save Changes</button>
							    </form>
                                <?php
...
$car_vin = $_POST['VIN'];
 ...
 $car_Saledate = $_POST['Sale_date'];
									...
									if ($result = $sql)
									{
										echo "<p>You have succesfully entred the data</p>";
									}
									else 
									{
										echo "<p>Erro entering data</p>";
									}
								}
