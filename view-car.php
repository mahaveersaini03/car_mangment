                                    ...
                                    <table class="table app-table-hover mb-0 text-left">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="cell">Trim</th>
                                                <th class="cell">Exterior Color</th>
                                                <th class="cell">Interior Color</th>
                                                <th class="cell">Asking Price</th>
                                                <th class="cell">Sale Price</th>
                                                <th class="cell">Purchase Price</th>
                                                <th class="cell">Mileage</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cell"><?php echo $row['Make'] ?></td>
